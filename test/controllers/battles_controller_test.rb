...
class BattlesControllerTest < ActionController::TestCase
  ...
  test "should create battle" do
    assert_difference('Battle.count') do
      post :create, battle: { creator: @battle.creator, description: @battle.description, name: @battle.name }
    end
  ...
  test "should update battle" do
    patch :update, id: @battle, battle: { creator: @battle.creator, description: @battle.description, name: @battle.name }
    assert_redirected_to battle_path(assigns(:battle))
  end
